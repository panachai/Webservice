...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2017 at 03:29 PM
...
(00000000001, 'IPHONE7', 00000000001, 'ไอโฟน7 ขนาดความจุ 64GB รองรับ wifi ac', '');
...
--
ALTER TABLE `categorydetail`
  MODIFY `catDeID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `customer`
--
ALTER TABLE `customer`
  MODIFY `cusID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `product`
  MODIFY `proID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `productdetail`
--
ALTER TABLE `productdetail`
  MODIFY `proDeID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
